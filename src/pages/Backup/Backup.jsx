  ...
  return (
    <View className="h-full">
      <View className="flex-none flex flex-row justify-end items-center">
        ...
        >
          <Text className="flex-shrink text-cornflower">
            Return to Dashboard
          </Text>
        </TouchableOpacity>
      </View>
      <View className="flex-1 space-y-6 flex flex-col justify-center">
        <View className="flex-none px-6">
          <Text className="text-lg text-cornflower">
            Create backup to have your medical records stored forever.
          </Text>
          <Text className="text-lg text-cornflower">
            Backup is encrypted and is only accessible to you.
          </Text>
          <Text className="text-lg text-cornflower">
            You can assign guardian that is able to restore access after
        ...
        />
        <TouchableOpacity
          className="bg-cornflower rounded-lg mx-6 px-6"
